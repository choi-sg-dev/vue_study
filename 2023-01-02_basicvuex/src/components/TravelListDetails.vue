...
<style>
  #travellist-details {color: white; background: teal; padding: 10px 20px;}
  #travellist-details ul {padding: 0; list-style-type: none;}
  #travellist-details li {margin: 10px; padding: 20px; background: #00695c;}
</style>